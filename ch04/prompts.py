...
Write {num_search_queries} web search queries to gather as much information as possible on the following questions: {user_question}. Your objective is
to write a report based ont eh information you find.
You much respond with a list of queries such as query1, query2, query3 in the following format:
[
...
----------------------------
Using the above test, anser in short the following quetion.
